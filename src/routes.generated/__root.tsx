...
function Root() {
  ...
  return <div className="p-2">
      <div className="flex gap-2 items-center text-lg mb-4">
        ...
        <a className="flex items-center ml-auto gap-1 hover:text-teal-600" href="https://github.com/capri-js/capri-tanstack-router-react/">
          View on GitHub
          <svg version="1.1" width="20" height="20" viewBox="0 0 16 16" aria-hidden="true">
